...
const spirv_cfg_splitpath = ["bin", "spirv-cfg.exe"]
...
const spirv_reduce_splitpath = ["bin", "spirv-reduce.exe"]
...
const spirv_val_splitpath = ["bin", "spirv-val.exe"]
...
const libSPIRV_Tools_splitpath = ["bin", "libSPIRV-Tools-shared.dll"]
...
const libSPIRV_Tools = "libSPIRV-Tools-shared.dll"


# Relative path to `spirv_opt`
const spirv_opt_splitpath = ["bin", "spirv-opt.exe"]
...
const spirv_as_splitpath = ["bin", "spirv-as.exe"]
...
const spirv_link_splitpath = ["bin", "spirv-link.exe"]
...
const spirv_dis_splitpath = ["bin", "spirv-dis.exe"]
