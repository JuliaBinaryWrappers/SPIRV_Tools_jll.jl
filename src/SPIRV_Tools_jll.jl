...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import SPIRV_Tools_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("6ac6d60f-d740-5983-97d7-a4482c0689f4"))
platforms = [Pkg.Artifacts.unpack_platform(e, "SPIRV_Tools", artifacts_toml) for e in artifacts["SPIRV_Tools"]]
...
if best_platform === nothing
    @debug("Unable to load SPIRV_Tools; unsupported platform $(triplet(platform_key_abi()))")
else
